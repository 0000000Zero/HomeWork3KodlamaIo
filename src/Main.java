...
public class Main {
	...
	public static void main(String[] args) throws Exception 
	{
		...
		Customer customer = new Customer(1,"tc no yazın ","Ad ","Soyad",1900);
     ...
     // customer Degiskeni Uzerinden Musteri Bilgilerini
        ...
        campaignManager.addCamping(campaing);
        ...
        campaignManager.updateCamping(campaing);
        campaignManager.deleteCamping(campaing);
